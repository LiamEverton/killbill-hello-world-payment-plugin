...
//Entry point for implementing https://docs.killbill.io/latest/payment_plugin.html.
public class HelloWorldPaymentPluginApi implements PaymentPluginApi {
    ...
    public HelloWorldPaymentPluginApi(final Properties properties) {
